...
void setup() {
  ...
  */
  ...
  // Simple OTA setup (commented out for now to avoid WiFi issues)
  // ArduinoOTA.begin(WiFi.localIP(), "esp32-smoker", "", InternalStorage);
  // Serial.println("OTA Ready");
}

void loop() {
  // ArduinoOTA.handle();  // Commented out for now
